...
<Row class="upcoming_webinar" noGutterMd>
  <Column colMd={8} colLg={8}>
  <span>MON, SEP 19 ‧ 7:00 PM CEST</span><br />
  <p><strong>Farm Proxy: Reduce your mining data load with hashrate aggregation!</strong></p>
  </Column>
  <Column colMd={4} colLg={4}>
  <button class="upcoming_webinar_calendar">Add to Calendar</button> <button class="upcoming_webinar_attend">Attend Online</button>
  </Column>
</Row>
